...
function Layout({ children, currentPage, navItems, onNavigate, onSignOut, user }) {
  return (
    <div className="min-h-screen bg-[#07080a] text-zinc-100 antialiased">
      ...
      <main className="relative min-h-screen px-4 pb-24 pt-4 sm:px-6 sm:pt-6 lg:ml-72 lg:px-8 lg:py-8">
